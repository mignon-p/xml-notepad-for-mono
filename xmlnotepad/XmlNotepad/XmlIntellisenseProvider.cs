                ...
                if (node.NodeType == XmlNodeType.Attribute) {
                    ...
                    if (expected != null) {
                        foreach (XmlSchemaAttribute a in expected) {
                            list.Add(GetQualifiedName(a), SchemaCache.GetAnnotation(a, SchemaCache.AnnotationNode.Tooltip));
                        }
                    }
                } else {
                    ...
                    if (particles != null) {
                        foreach (XmlSchemaParticle p in particles) {
                            if (p is XmlSchemaElement) {
                                list.Add(GetQualifiedName((XmlSchemaElement)p), SchemaCache.GetAnnotation(p, SchemaCache.AnnotationNode.Tooltip));
                            } else {
