...
namespace XmlNotepad {
    ...
    public class XmlTreeView : System.Windows.Forms.UserControl {
        ...
        public void StartIncrementalSearch() {
            ...
            } else if (this.nodeTextView.ContainsFocus) {
    ...
    public class XmlTreeNode : TreeNode {
        ...
        public virtual string GetToolTip() {
            ...
            XmlSchemaInfo si = this.XmlTreeView.Model.GetTypeInfo(this.Node);
            if (si != null) {
                foreach (XmlSchemaAnnotated a in new XmlSchemaAnnotated[] {
                                                     si.SchemaElement, si.SchemaAttribute, 
                                                     si.MemberType, si.SchemaType}) {
                    if (a != null) {
                        string s = SchemaCache.GetAnnotation(a, SchemaCache.AnnotationNode.Tooltip);
        ...
        public virtual XmlDocument GetDocumentation() {
            ...
            if (si != null) {
                foreach (XmlSchemaAnnotated a in new XmlSchemaAnnotated[] {
                                                     ...
                                                     si.MemberType, si.SchemaType}) {
                    if (a != null) {
                        XmlSchemaDocumentation d = SchemaCache.GetDocumentation(a);
